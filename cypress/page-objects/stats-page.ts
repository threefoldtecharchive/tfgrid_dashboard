...
class StatsPage {
  get getNodesCard() {
    return cy.xpath(
      '//*[@id="app"]/div[1]/div[3]/div/div[2]/section/div[1]/div/div/p'
    );
  }

  get getFarmsCard() {
    return cy.xpath(
      '//*[@id="app"]/div[1]/div[3]/div/div[2]/section/div[2]/div/div/p'
    );
  }

  get getCountriesCard() {
    return cy.xpath(
      '//*[@id="app"]/div[1]/div[3]/div/div[2]/section/div[3]/div/div/p'
    );
  }

  get getCpuCard() {
    return cy.xpath(
      '//*[@id="app"]/div[1]/div[3]/div/div[2]/section/div[4]/div/div/p'
    );
  }

  get getSsdCard() {
    return cy.xpath(
      '//*[@id="app"]/div[1]/div[3]/div/div[2]/section/div[5]/div/div/p'
    );
  }

  get getHddCard() {
    return cy.xpath(
      '//*[@id="app"]/div[1]/div[3]/div/div[2]/section/div[6]/div/div/p'
    );
  }

  get getRamCard() {
    return cy.xpath(
      '//*[@id="app"]/div[1]/div[3]/div/div[2]/section/div[7]/div/div/p'
    );
  }

  get getAccessNodesCard() {
    return cy.xpath(
      '//*[@id="app"]/div[1]/div[3]/div/div[2]/section/div[8]/div/div/p'
    );
  }

  get getGatewaysCard() {
    return cy.xpath(
      '//*[@id="app"]/div[1]/div[3]/div/div[2]/section/div[9]/div/div/p'
    );
  }

  get getTwinsCard() {
    return cy.xpath(
      '//*[@id="app"]/div[1]/div[3]/div/div[2]/section/div[10]/div/div/p'
    );
  }

  get getPublicIpsCard() {
    return cy.xpath(
      '//*[@id="app"]/div[1]/div[3]/div/div[2]/section/div[11]/div/div/p'
    );
  }

  get getContractsCard() {
    return cy.xpath(
      '//*[@id="app"]/div[1]/div[3]/div/div[2]/section/div[12]/div/div/p'
    );
  }

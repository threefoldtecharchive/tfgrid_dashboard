...
REQUIRED_ENV_VARS=( APP_GRAPHQL_URL APP_GRIDPROXY_URL APP_VERSION APP_API_URL APP_ACTIVATION_SERVICE_URL PLAYGROUND_URL RELAY )
...
window.configs = {
  ...
  APP_ACTIVATION_SERVICE_URL: '$APP_ACTIVATION_SERVICE_URL',
  APP_EXPLORER_URL: '$EXPLORER_URL',
  APP_GRAPHQL_URL: '$APP_GRAPHQL_URL',
  APP_GRIDPROXY_URL: '$APP_GRIDPROXY_URL',
  APP_NETWORK: '$NETWORK',
